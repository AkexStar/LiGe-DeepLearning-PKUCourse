...
def plot_dataset_samples_imgs(
    dataset, n_plots=4, figsize=DFLT_FIGSIZE, ax=None, pad_value=1, seed=123, title=None, normalize=False, value_range=()
):
    ...
    grid = make_grid(img_tensor, nrow=2, pad_value=pad_value, normalize=normalize, value_range=value_range)
